...
export default function ModalPopProgram({ modalOpen, setModalOpen, modalInfo }) {
        ...
        <ModalDialog>
          ...
          <DialogTitle className={modalInfo?.typeColor}>
            ...
            {/* <Button
              ...
              id="wit"
              size="sm"
              variant={moodState === "wit" ? "solid" : "soft"}
            >
              위트
            </Button>
            <Button
              ...
              id="lively"
              size="sm"
              variant={moodState === "lively" ? "solid" : "soft"}
            >
              발랄
            </Button> */}
          </DialogTitle>
          ...
          >
            <CusStack spacing={2}>
              ...
              <Button type="submit">참여 하기</Button>
            </CusStack>
          </form>
        </ModalDialog>
      </Modal>
